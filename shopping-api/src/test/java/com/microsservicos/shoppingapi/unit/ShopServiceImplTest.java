...
public class ShopServiceImplTest {
  ...
  public void saveUserNotFoundExceptionTest() {
    ...
    assertThatExceptionOfType(UserNotFoundException.class).isThrownBy(() -> shopService.save(ORDER_2_DTO, "0000"));
  }

  @Test
  public void saveIllegalProductExceptionTest() {
    when(userService.getUserByCpf(anyString(), anyString())).thenReturn(user);
    when(productService.getProductByIdentifier(anyString())).thenReturn(null);

    assertThatExceptionOfType(IllegalProductException.class).isThrownBy(() -> shopService.save(ORDER_2_DTO, "0000"));
  }
  ...
  public void saveSuccessTest() {
    ...
    ShopDto result = shopService.save(ORDER_2_DTO, "0000");
